...
| 계약 | 주요 책임 | 주요 상호 작용 |
| ------------------------- | -------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------- |
| **FXSwapMaster** | 풀의 중앙 관리, 스왑 라우팅, 수수료 집계, 비율 제한 | 스왑을 위해 HybridStablePool 호출; InstitutionalRegistry 및 PriceOracle 쿼리 |
| **HybridStablePool** | 유동성 준비금 유지; 소매 AMM 및 기관 오라클 기반 스왑 실행 | FXSwapMaster로부터 스왑 요청 수신; 준비금 및 수수료 업데이트 |
| **PriceOracle** | FX 비율 데이터 저장 및 검증; 편차 및 신선도 제약 시행 | HybridStablePool 및 FXSwapMaster에 가격 데이터 제공 |
| **InstitutionalRegistry** | 기관 사용자 온보딩, 권한 및 위험 매개변수 관리 | 기관 스왑 승인; 제한 및 수수료율 시행 |
