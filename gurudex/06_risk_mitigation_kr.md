...
|---|---|---|---|---|
| **Level 1** | **HEALTHY<br/>(정상)** | 80% 이상 | - 정상 운영<br/>- 표준 수수료 적용 | 모든 거래 정상 작동 |
| **Level 2** | **WARNING<br/>(경고)** | 60-80% | - 동적 수수료 증가 시작<br/>- 블록당 스왑 횟수 제한<br/>- 모니터링 강화 | 대규모 거래 일부 제한 |
| **Level 3** | **CRITICAL<br/>(위험)** | 40-60% | - 동적 수수료 대폭 인상<br/>- 거래당 최대 금액 제한 강화<br/>- 긴급 유동성 요청 | 스왑 제한 강화<br/>일부 거래 차단 가능 |
| **Level 4** | **EMERGENCY<br/>(긴급)** | 40% 미만 | - 모든 신규 스왑 중단<br/>- 긴급 유동성 공급 실행<br/>- RFQ 활성화<br/>- 풀 간 자동 리밸런싱 | 거래 전면 중단<br/>Operator 개입 필수 |
