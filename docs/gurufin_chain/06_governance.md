...
* **Timelock:** **Phase 1 — None**. (If a proposal achieves quorum and passes the voting threshold, it is executed immediately upon the conclusion of the voting period).
