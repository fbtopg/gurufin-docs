...
Delegated Proof-of-Stake (DPoS) determines consensus participation. Delegated stakeholders assign GXN stake to validators, and block producers are selected based on total stake weight.
