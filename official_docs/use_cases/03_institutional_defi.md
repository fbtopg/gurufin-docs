...
* **Collateral and treasury management:** OPRS helps execute collateral rebalancing or FX hedging against oracle-guided rates, with time-weighted execution available for larger orders.
...
3. **Structured product issuance:** Automate issuance and redemption of tokenized products anchored to fiat reserves and banking partner integrations.
